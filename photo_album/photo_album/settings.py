...
# CSRF Trusted Origins - Add your domain(s) here
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'album' / 'templates',  # Prioritize our templates over Django's built-in ones
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# CORS settings - Security configured
...
if DEBUG:
    ...
    if cors_origins:
        ...
        # Fallback: Restrict to same origin only
        CORS_ALLOWED_ORIGINS = []

# Never allow all origins in any environment
