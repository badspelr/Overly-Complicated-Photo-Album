...
from .views.album_views import AlbumListView, AlbumDetailView, create_album, delete_album, album_viewers, remove_viewer, create_share_link, shared_album, manage_share_links, delete_share_link, download_full_album
from .views.media_views import PhotoListView, PhotoDetailView, VideoListView, VideoDetailView, delete_media, bulk_delete, bulk_download, search_media, photo_edit, video_edit, minimal_upload, toggle_favorite, toggle_video_favorite, favorites_list, mobile_download_page, download_single_item, process_videos_ai, process_photos_ai, rotate_photo
from .views.category_views import CategoryCreateView, CategoryUpdateView, CategoryDeleteView, CategoryListView
from .views.base_views import about_view, contact_view, ai_settings_view, cookie_policy_view, documentation_index, documentation_view
from .views.server_import import server_import_view
...
urlpatterns = [
    ...
    path('albums/<int:pk>/download/', download_full_album, name='download_full_album'),
    ...
    path('server-import/', server_import_view, name='server_import'),
    ...
    path('photos/<int:pk>/rotate/', rotate_photo, name='rotate_photo'),
    ...
    path('videos/<int:video_id>/favorite/', toggle_video_favorite, name='toggle_video_favorite'),
    ...
    path('docs/<path:doc_path>/', documentation_view, name='documentation_view'),
]
